...
exports.entitiesField = {
    ...
    resolve(_source, { representations }, context, info) {
        return representations.map((reference) => {
            ...
            const resolveReference = (_f = (_e = (_d = (_c = type.extensions) === null || _c === void 0 ? void 0 : _c.apollo) === null || _d === void 0 ? void 0 : _d.subgraph) === null || _e === void 0 ? void 0 : _e.resolveReference) !== null && _f !== void 0 ? _f : function defaultResolveReference() {
                return reference;
            };
